<?php
include('ASSsession.php'); // Includes Login Script
if(isset($_SESSION['login_assistant'])){
header("location: ASSindex.php"); // Redirecting To Profile home Page
}
?>
...
<head>
  ...
  <script type="text/javascript" src="../js/ASSlogin.js"> </script>
    ...
    <div class="main-wrapper">
      <div class="page-wrapper full-page-wrapper d-flex align-items-center justify-content-center">
        <main class="auth-page">
          <center><p class="w3-xxlarge">ASSISTANT LOGIN</p></center> <br> <br>
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-1-tablet"></div>
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4-desktop mdc-layout-grid__cell--span-6-tablet">
                <div class="mdc-card">
                  <form name = "ASSlogin"  method="post" onsubmit="return (validateData());">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
