          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                ...
                <div>
                  <h6 class="card-title card-padding pb-0">Salon Services</h6>
                  <form method="post" >
                  ...
                  <td><div class='mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop'>
                          <div class='mdc-text-field mdc-text-field--outlined'>
                            <input class='mdc-text-field__input' id='text-field-hero-input' value='' name="ser_id">
                            <div class='mdc-notched-outline'>
                              <div class='mdc-notched-outline__leading'></div>
                              <div class='mdc-notched-outline__notch'>
                                <label for='text-field-hero-input' class='mdc-floating-label' >Service ID </label>
                              </div>
                  ...
                  <td><div class='mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop'>
                          <div class='mdc-text-field mdc-text-field--outlined'>
                            <input class='mdc-text-field__input' id='text-field-hero-input' value='' name="price_range">
                            <div class='mdc-notched-outline'>
                              <div class='mdc-notched-outline__leading'></div>
                              <div class='mdc-notched-outline__notch'>
                                <label for='text-field-hero-input' class='mdc-floating-label' >Price Range</label>
                              </div>
                              <div class='mdc-notched-outline__trailing'></div>
                            </div>
                          </div>
                  ...
                  if (isset($_POST["btnsave"])){
                    ...
                    $query ="UPDATE `service` SET `price_range`='$price_range' WHERE `ser_id`='$ser_id'";
                  ...
                  <div class="table-responsive">
                   ...
                   <?php 
                    ...
                    $sql = "SELECT ser_id, ser_name, price_range, category FROM service";
                   ...
                   echo " <table class='table table-hoverable'>
                      ...
                      while($row = $result->fetch_assoc()) {
                        echo "<tbody>
                        <tr>
                          <td class='text-left'>" . $row["ser_id"]. "</td>
                          <td>" . $row["ser_name"]. "</td>
