            ...
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Confirmed Appointments</h6>
                  ...
                  <?php 
                    ...
                    $sql = "SELECT confAppo_id, appo_id, date, time, cus_email, ser_name FROM confirmed_appointments";
                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                   
                   echo "<br> <table class='table table-hoverable' >
                      <thead>
                      <tr>
                      <th >Confirmed Appo. ID</th>
