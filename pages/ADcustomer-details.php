                ...
                <div>
                  ...
                  <td><div class='mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop'>
                          <div class='mdc-text-field mdc-text-field--outlined'>
                            <input class='mdc-text-field__input' id='text-field-hero-input' value='' name="cus_id">
                            <div class='mdc-notched-outline'>
                              <div class='mdc-notched-outline__leading'></div>
                              <div class='mdc-notched-outline__notch'>
                                <label for='text-field-hero-input' class='mdc-floating-label' >Enter Id</label>
                              </div>
                        ...
                        <td></td>
                        <td>
                            <button class='mdc-button mdc-button--raised icon-button filled-button--secondary' name='btndelete'>
                  ...
                  if (isset($_POST["btndelete"])){
                    ...
                    $query ="DELETE FROM customer WHERE cus_id = ' $userid' ";
